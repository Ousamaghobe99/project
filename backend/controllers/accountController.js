...
export const createAccount = async (req, res) => {
  try {
    ...
    const { name, amount, account_nb, a_description,account_type } = req.body;
    ...
    const createAccountResult = await pool.query({
      text: `INSERT INTO tblaccount(user_id, account_name, account_number,account_type, account_balance,description) VALUES($1, $2, $3, $4,$5,$6) RETURNING *`,
      values: [userId, name,account_nb,account_type, amount,a_description],
    });
    ...
    const initialDepositDescription = account.account_name + " (Initial Deposit)";
