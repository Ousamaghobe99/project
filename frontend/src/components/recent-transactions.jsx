                          ...
                          >
                              <td className="py-4">
                                  <div className="flex flex-col">
                                      <p className="text-base font-medium text-black 2xl:lg dark:text-gray-400 line-clamp-1">
                            ...
                            <td className="flex items-centre px-2 py-4 font-medium text-black dark:text-gray-400">
